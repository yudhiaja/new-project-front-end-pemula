...
const composeBookObject = (bookJudul, bookPengarang, bookTahun, isCompleted) => {
  return {
    id: +new Date(),
    bookJudul,
    bookPengarang,
...
const refreshDataFromBooks = () => {
  ...
  for (book of books) {
    const newBook = makeBook(book.bookJudul, book.bookPengarang, book.bookTahun , book.isCompleted);
